export const FACT = {
    ...
    "fields": {
      "concept.balance-type": {
        "searchable": true,
        "type": "text",
        "database_field": "CASE WHEN element.balance_id = 1 THEN 'debit' ELSE CASE WHEN element.balance_id = 2 THEN 'credit' END END",
        "definition": "The balance type of a concept. This can be either debit, credit or not defined.",
        "config": {
          "type": "toggle",
          "options": ["debit", "credit", "any"],
          "fields": true,
          "parameters": true,
        }
      },
      ...
      "concept.id": {
        ...
        "definition": "A unique identification id of the concept that can be searched on. This is a faster way to retrieve the details of a fact, however it is namespace specific and will only search for the use of a concept for a specific schema. ",
        "format": "integer"
      },
      "concept.is-base": {
        "searchable": true,
        ...
        "definition": "Identifies if the concept is from a base published taxonomy or from a company extension. Avalue of true indicates that it is a base taxonomy element. This attribute can be used for example to search for extension elements in a filing.",
        "format": "boolean"
      },
      "concept.is-monetary": {
        "searchable": true,
        ...
        "definition": "Identifies if the concept is a monetary value. If yes the value is shown as true. A monetary value is distinguished from a numeric concept in that it has a currency associated with it.",
        "format": "boolean"
      },
      "concept.local-name": {
        "searchable": true,
        ...
        "definition": "The concept name in the base schema of a taxonomy excluding the namespace, such as Assets or Liabilities. Use this to search across multiple taxonomies where the local name is known to be consistent over time.",
        "format": "concept"
      },
      "concept.namespace": {
        "searchable": true,
      ...
      "concept.period-type": {
        "searchable": false,
        "type": "text",
        "database_field": "CASE WHEN element.period_type_id = 1 THEN 'instant' ELSE CASE WHEN element.period_type_id = 2 THEN 'duration' END END",
      ...
      "dimension.is-base": {
        ...
        "definition": "A boolean that indicates if the dimension concept is a base taxonomy element (true) or an extensions dimension concept (false).",
        "format": "boolean"
      },
      "dimension.local-name": {
        ...
        "definition": "The dimension concept name in the taxonomy excluding the namespace, that is defined as dimension type.",
        "format": "concept"
      },
      "dimension.namespace": {
        "searchable": true,
      ...
      "dimensions.id": {
        ...
        "definition": "The unique identifier of the dimensional aspects associated with a fact."
      },
      "dts.entry-point": {
        "searchable": true,
        "type": "varchar",
        "database_field": "document_uri",
        "definition": "The url entry point of a discoverable taxonomy set. This is also referred to as the entry point for a taxonomy. A taxonomy can have multiple entry points and the resulting set of taxonomies of using an entry point is called a dts.",
        "format": "uri"
      },
      "dts.id": {
        "searchable": true,
        ...
        "definition": "The dts identifier for a given group of taxonomies. XBRL facts and linkbases are typically associated with a given report that is associated with a dts.",
        "format": "integer"
      },
      ...
      "member.is-base": {
        ...
        "definition": "A boolean value that indicates if the member is a base element in the reporting taxonomy or a company extension.",
        "format": "boolean"
      },
      "member.local-name": {
        "searchable": true,
      ...
      "member.member-value": {
        ...
        "definition": "Typed value or local-name of the member depending on the dimension type."
      },
      "member.namespace": {
        "searchable": true,
        "type": "varchar",
      ...
      "period.fiscal-id": {
        ...
        "definition": "The identifier of the fiscal period. Each period has an assigned hash which identifies the fiscal period. The hash can be used to search for periods that are identical. Periods with the same period and year in fact nay be different as the fiscal periods and years are approximations. ",
        "format": "hex_hash"
      },
      ...
      "period.id": {
        ...
        "definition": "The identifier of the calender period. Each period has an assigned hash which identifies the period. The hash can be used to search for periods that are identical. Periods with the same period and year in fact nay be different as the fiscal periods and years are approximations. ",
        "format": "hex_hash"
      },
      "period.instant": {
        "searchable": true,
        ...
        "definition": "Instant in time at which the fact was measured, inly applicable for facts with a period type of instant."
      },
      "period.start": {
        "searchable": false,
        "type": "timestamp",
      ...
      "report.entry-url": {
        ...
        "definition": "The url entry point of a discoverable taxonomy set. This is also referred to as the entry point for a taxonomy. This represents the DTS entry point for a specific report.",
        "format": "uri"
      },
      "report.event-items": {
        "searchable": true,
      ...
      "report.hash": {
        ...
        "definition": "A hash of all the filings information, facts, footnotes, etc.  Unique to each filing.",
        "format": "hex_hash"
      },
      "report.html-url": {
        "searchable": true,
      ...
      "report.restated": {
        ...
        "definition": "A boolean that indicates if the report has been subsequently restated.  A value of true represents that the report has been subsequently restated by another report.  A value of false means that this report has not been subsequently restated by another report.",
        "format": "boolean"
      },
      "report.restated-index": {
        ...
        "type": "text",
        "database_field": "restatement_index",
        "definition": "A numerical indicator that can be used to identify if a report has been restated. If the value is 1 it indicates that this is the latest report. If the value is 2 it means that an updated copy of the report has been filed.",
        "format": "submission"
      },
      "report.sec-url": {
        "searchable": true,
        ...
        "definition": "The url at which the details of a filing can be accessed from the SEC Edgar system.",
        "format": "uri"
      },
      "report.sic-code": {
        "searchable": true,
        ...
        "definition": "Integer that represents the Standard Industrial Classification (SIC) code used by the SEC in the United States.",
        "format": "integer"
      },
      "report.source-id": {
        "searchable": true,
      ...
      "report.submission-type": {
        ...
        "definition": "A FERC filing identifier indicating if it's the first time it was filed or a subsequent one.  (O = Original; R = Restated)",
        "format": "integer"
      },
      "report.type": {
        "searchable": false,
        ...
        "definition": "The report type indicates if the report was filed in inline XBRL or XBRL format. The values can be either instance or inline."
      },
      "report.year-focus": {
        "searchable": true,
        "type": "text",
      ...
      "unit.qname": {
        "searchable": false,
        "type": "text",
        "database_field": "CASE WHEN unit.unit_id IS NULL THEN NULL ELSE COALESCE( (SELECT string_agg( '{' || q1.namespace || '}' || q1.local_name, ' * '::varchar) AS uom FROM unit_measure um1 JOIN qname q1 ON um1.qname_id = q1.qname_id WHERE um1.location_id = 1 AND um1.unit_id = unit.unit_id), (SELECT concat_ws('/', (SELECT string_agg('{' || q2.namespace || '}' ||q2.local_name, ' * '::varchar) FROM unit_measure um2 JOIN qname q2 ON um2.qname_id = q2.qname_id WHERE um2.unit_id = unit.unit_id AND um2.location_id = 2), (SELECT string_agg('{' || q3.namespace || '}' || q3.local_name, ' * '::varchar) FROM unit_measure um3 JOIN qname q3 ON um3.qname_id = q3.qname_id WHERE um3.unit_id = unit.unit_id AND um3.location_id = 3)))) END",
        "definition": "The full qname of the unit of measure, includes the namespace of the unit in clark notation."
      }
    }
  }